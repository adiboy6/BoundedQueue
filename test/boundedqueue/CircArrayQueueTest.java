...
public class CircArrayQueueTest {
    ...
    public void capacity() {
        Queue<String> ab2 = new CircArrayQueue<>(2);
    ...
    public void length() {
        ...
        Queue<String> length_queue = new CircArrayQueue<>(4  );
    ...
    public void newInstance() {
        ...
        assertTrue(newInstancequeue instanceof CircArrayQueue<String>);
    ...
    public void appendAll() {
        Queue<String> temp_queue = new CircArrayQueue<>(3);
    ...
    public void testABC6EqualsForObjectABC6() {
        Queue<String> ABC6 = new CircArrayQueue<>(6);
        ABC6.enqueue("A");
        ABC6.enqueue("B");
        ABC6.enqueue("C");
        assertTrue(abc6.equals(ABC6));
    ...
    public void testABC6EqualsForObjectAB6() {
        Queue<String> ab6 = new CircArrayQueue<>(6);
        ab6.enqueue("A");
        ab6.enqueue("B");
    ...
    public void testEmpty3EqualsForDifferentEmpty() {
        Queue<String> empty3 = new CircArrayQueue<>(3);
        Queue<String> empty3_dup = new CircArrayQueue<>(3);
    ...
    public void toStringEmpty() {
        Queue<String> queue_3 = new CircArrayQueue<>(3);
    ...
    public void isEmpty() {
        ...
        Queue<String> queue1 = new CircArrayQueue<>(1);
    ...
    public void isFull() {
        ...
        Queue<String> a1 = new CircArrayQueue<>(1);
        a1.enqueue("A");
    ...
    public void testIllegalArgumentException() {
        Queue<String> queue_6 = new CircArrayQueue<>(6);
        queue_6.enqueue(null);
    }

    @org.junit.Test
    public void testDifferentABCD6() {
        Queue<String> abcd6 = new CircArrayQueue<>(6);
        abcd6.enqueue("A");
        abcd6.enqueue("B");
        abcd6.enqueue("C");
        abcd6.enqueue("D");
